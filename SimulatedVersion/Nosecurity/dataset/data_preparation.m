...
num_genes=16000;     % set the number of top variable genes;
num_cells_1=2000;     % set the number of cells (first type);
num_cells_2=2000;      % set the number of cells (second type);
%num_cells_3=2000;       % set the number of cells (third type);
...
save('datasets/CD4+_CD45RA+_CD25-.mat','full_gene_trun_cell_trun_comb2_perm','full_gene_trun_cell_trun_label_comb2_perm');
